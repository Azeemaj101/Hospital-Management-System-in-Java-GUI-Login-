...
public class PharmacyLogin extends JFrame {
	 ...
	 *
	 */
	private Image img_UserName =new ImageIcon(PharmacyLogin.class.getResource("UserName.JPG")).getImage().getScaledInstance(50, 40, Image.SCALE_SMOOTH);
	private Image img_logo =new ImageIcon(PharmacyLogin.class.getResource("Logo.jpg")).getImage().getScaledInstance(220, 140, Image.SCALE_SMOOTH);
    private Image img_Password =new ImageIcon(PharmacyLogin.class.getResource("Lock.jpg")).getImage().getScaledInstance(60, 40, Image.SCALE_SMOOTH);
    private Image img_Login =new ImageIcon(PharmacyLogin.class.getResource("Key.png")).getImage().getScaledInstance(90, 80, Image.SCALE_SMOOTH);
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PharmacyLogin frame = new PharmacyLogin();
	...
	public PharmacyLogin() {
		...
		panel_1.setBounds(31, 116, 250, 40);
		panel.add(panel_1);
		...
		panel_1_1.setBounds(31, 167, 250, 40);
		panel.add(panel_1_1);
		...
		panel_2.setBorder(new LineBorder(new Color(220, 20, 60), 2));
		...
		panel_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				panel_2.setBackground(new Color(0, 0, 31));
			}
			@Override
		...
		panel_2.setBackground(new Color(0, 0, 51));
		panel_2.setBounds(31, 241, 250, 63);
		panel.add(panel_2);
		...
		lblLoginMessage.setBounds(31, 210, 250, 20);
		panel.add(lblLoginMessage);
		
		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setBorder(new LineBorder(new Color(255, 0, 0), 2));
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\Azeem\\eclipse-workspace\\2Semester(HMS)Project\\Parmachy5.jpg"));
