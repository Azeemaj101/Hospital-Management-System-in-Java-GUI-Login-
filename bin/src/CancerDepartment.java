...
public abstract class CancerDepartment implements ReceptionistR ,PatientPayment
{
	...
	public void Login(int Password) throws InterruptedException
	{
		...
		while(f==false)
		{
			...
			{
				System.out.println("Cancer Department");
				System.out.println("Welcome Back Admin (Cancer Department)");
	...
	public void insertNew ()throws IOException
	{
	    ...
	    Fout=new FileWriter("CancerDepartment.txt" ,false);
	...
	public void Hview () throws IOException
	{
		...
		Fin=new FileReader("CancerDepartment.txt");
...
class Cancerreceptionist extends CancerDepartment
{
	...
	public void RCNinsertNew ()throws IOException
	{
		int []doctorID=new int[13];
		int []doctorTime=new int[13];
		FileWriter Fout;
		BufferedWriter Bout = null;
	    Fout=new FileWriter("CancerReceptionist.txt" ,true);
	    Bout=new BufferedWriter(Fout);
	    for(int i=0 ; i<=ReceptionistR.TotalDoctors ; i++)
		{
	...
	public void RCNview () throws IOException
	{
		int [] DoctorID =new int[13];
		int [] DoctorTime=new int[13];
	...
	void RCNSearch(int FindID)throws IOException
	{
		int [] DoctorID =new int[13];
		int [] DoctorTime=new int[13];
		String [] DoctorName=new String[13];
	...
	void RCNDelete(int Delete)throws IOException
	{
		int [] DoctorID =new int[13];
		int [] DoctorTime=new int[13];
		String [] DoctorName=new String[13];
		int i=0;
	    File fileA=new File("CancerReceptionist.txt");
	...
	void RCNUpdate(int Find)throws IOException
	{
		int [] DoctorID =new int[13];
		int [] DoctorTime=new int[13];
		String [] DoctorName=new String[13];
		int i=0;
	    File file=new File("CancerReceptionist.txt");
	...
	public void CDFindDoctor() throws IOException, InterruptedException
	{
		...
		if(DoctorTime[i]==Time)
	    {
	    	...
	    	System.out.println("Doctor     Fee = 8000");
			Payment.PatientPament(PatientPayment.CancerDoctorPayment);
	    }
	    }
	    Fin.close();
	    Bin.close();
