...
public abstract class CoronaDepartment implements ReceptionistR ,PatientPayment
{
	...
	public void Login(int Password) throws InterruptedException
	{
		...
		while(f==false)
		{
			...
			{
				System.out.println("Corona Department");
				System.out.println("Welcome Back Admin (Corona Department)");
	...
	public abstract void DoctorKit(); 
	public void insertNew ()throws IOException
	{
		FileWriter Fout;
		BufferedWriter Bout = null;
	    Fout=new FileWriter("CoronaDepartment.txt" ,false);
	...
	public void Hview () throws IOException
	{
		...
		Fin=new FileReader("CoronaDepartment.txt");
	    ...
	    while(Obj.hasNext())
	    {
	    	...
	    	System.out.println("Head    Of      Corona Department is = "+HeadName 
	    			        +"\nBlock Number Of Corona Department is = "+BlockNumber+"\n");
	    }
	    Fin.close();
	    Bin.close();
	    Obj.close();
...
class Coronareceptionist extends CoronaDepartment
{
	...
	public void CRinsertNew ()throws IOException
	{
		int []doctorID=new int[13];
		int []doctorTime=new int[13];
		FileWriter Fout;
		BufferedWriter Bout = null;
	    Fout=new FileWriter("CoronaReceptionist.txt" ,true);
	    Bout=new BufferedWriter(Fout);
	    for(int i=0 ; i<=ReceptionistR.TotalDoctors ; i++)
		{
	...
	public void RCview () throws IOException
	{
		int [] DoctorID =new int[13];
		int [] DoctorTime=new int[13];
		...
		FileReader Fin;
		BufferedReader Bin = null;
		Fin=new FileReader("CoronaReceptionist.txt");
	    Bin=new BufferedReader(Fin);
		Scanner Obj=new Scanner(Bin);
	    while(Obj.hasNext())
	    {
	...
	void RCSearch(int FindID)throws IOException
	{
		int [] DoctorID =new int[13];
		int [] DoctorTime=new int[13];
		String [] DoctorName=new String[13];
	...
	void RCDelete(int Delete)throws IOException
	{
		...
		String [] DoctorName=new String[13];
		int i=0;
	    File fileA=new File("CoronaReceptionist.txt");
	...
	void RCUpdate(int Find)throws IOException
	{
		int [] DoctorID =new int[13];
		int [] DoctorTime=new int[13];
		String [] DoctorName=new String[13];
		int i=0;
	    File file=new File("CoronaReceptionist.txt");
	...
	public void DoctorKit()
	{
		System.out.println("Total Kits 30");
		System.out.println("13 Kits used");
	}
	public void COFindDoctor() throws IOException, InterruptedException
	{
		...
		if(DoctorTime[i]==Time)
	    {
	    	...
	    	System.out.println("Doctor     Fee = 5000");
	    	Payment.PatientPament(PatientPayment.CoronaDoctorPayment);
	    }
	    }
	    Fin.close();
	    Bin.close();
...
class IsolationWard extends Coronareceptionist
{
	final static int Quarantine=14;
	final static int Symptom=7;
	public void QuarantineDuration()
	{
		System.out.println("Quarantine Duration = "+Quarantine);
	}
	public void Symptom()
	{
		System.out.println("Total Symptoms = "+Symptom);
		System.out.println("Symptoms usually begin 2 to 14 days after you come into contact with the virus.");
		System.out.println("Fever: 99%\r\n" +"Fatigue:70%\r\n" + "A dry cough: 59%\r\n" + "Loss of appetite: 40%\r\n" + "Body aches: 35%\r\n" + "Shortness of breath: 31%\r\n" + "Mucus or phlegm: 27%");
	}
	public void Food()
	{
		System.out.println("Crowd Fish");
	}
}
